...
class Doll(models.Model):
    ...
    id = models.PositiveIntegerField(unique=True, primary_key=True, verbose_name='전술 인형 넘버링')
    ...
    build_time = models.PositiveIntegerField(blank=True, null=True, verbose_name='전술 인형 제조 시간')
    grow = models.PositiveIntegerField(blank=True, null=True)
