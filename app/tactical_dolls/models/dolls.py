...
class Dolls(models.Model):
    ...
    doll_cv = models.CharField(max_length=50, blank=True, verbose_name='성우', null=True)
    doll_illustrator_creator = models.CharField(max_length=50, blank=True, verbose_name='일러스트레이터', null=True)
